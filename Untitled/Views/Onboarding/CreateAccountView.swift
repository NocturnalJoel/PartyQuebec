    ...
    var body: some View {
        ...
        NavigationView {
            VStack (spacing: 25) {
                ...
                CustomField(question: "First Name", answer: $firstName)
                
                CustomField(question: "Last Name", answer: $lastName)
                
                CustomField(question: "Email", answer: $email)
                
                CustomField(question: "Password", answer: $password)
