...
struct VerifyHostView: View {
    ...
    var body: some View {
        ...
        VStack {
            ...
            CustomField(question: "Full Name on ID", answer: $fullName)
            
            CustomField(question: "Adress on ID", answer: $address)
            
            CustomField(question: "Type of card/ID", answer: $typeOfID)
